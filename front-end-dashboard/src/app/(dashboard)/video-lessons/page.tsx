...
const videoLessons = [
  ...
  },
  {
    ...
    description:
      "Essential phrases and techniques for conducting successful business meetings in English.",
  ...
  },
  {
    ...
    description:
      "Proven strategies and techniques to achieve Band 9 in IELTS Speaking test with real examples.",
    thumbnail: "/placeholder.svg?height=200&width=300",
    duration: "28:35",
    views: 156000,
    likes: 12000,
  ...
  },
  {
    ...
    description:
      "Learn how to make engaging small talk in any situation. Build confidence in casual conversations.",
    thumbnail: "/placeholder.svg?height=200&width=300",
    duration: "18:24",
    views: 67000,
    likes: 4800,
  ...
  },
  {
    ...
    description:
      "Master complex English grammar patterns and sentence structures for advanced communication.",
    thumbnail: "/placeholder.svg?height=200&width=300",
    duration: "31:12",
    views: 43000,
    likes: 3200,
  ...
  },
  {
    ...
    description:
      "Learn the most important English words for everyday communication with memory techniques.",
    thumbnail: "/placeholder.svg?height=200&width=300",
    duration: "45:18",
    views: 198000,
    likes: 15000,
  ...
  },
  {
    ...
    description:
      "Complete guide to job interviews in English with common questions and perfect answers.",
    thumbnail: "/placeholder.svg?height=200&width=300",
    duration: "26:33",
    views: 87000,
    likes: 6500,
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Learn English with expert-led video lessons
        </p>
      </div>
          ...
          {filteredVideos.length > 0 ? (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {filteredVideos.map((video) => (
                ...
                >
                  <Link href={`/video-player-page/${video.id}`}>
