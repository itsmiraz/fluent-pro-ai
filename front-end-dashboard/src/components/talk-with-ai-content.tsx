...
import { MessageCircle, Mic, Send, Zap, Clock, Target, TrendingUp, Volume2 } from "lucide-react"
...
export function TalkWithAIContent({ onboardingData }: TalkWithAIContentProps = {}) {
  ...
  const getPersonalizedStats = (onboardingData?: OnboardingData) => {
    ...
    const multiplier = level === "beginner" ? 0.8 : level === "intermediate" ? 1 : 1.2
    ...
    return {
      ...
      averageScore: Math.floor(75 + (level === "advanced" ? 15 : level === "intermediate" ? 10 : 0)),
    ...
    <>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Practice conversations with your AI partner - chat or speak naturally</p>
        </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-blue-600">{stats.todayMinutes}</p>
                <p className="text-xs text-muted-foreground">Minutes Today</p>
                <Progress value={(stats.todayMinutes / stats.targetMinutes) * 100} className="h-1 mt-1" />
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-green-600">{stats.conversationsToday}</p>
                <p className="text-xs text-muted-foreground">Conversations</p>
                <Progress value={(stats.conversationsToday / stats.targetConversations) * 100} className="h-1 mt-1" />
              </div>
              <div className="text-center">
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Specialized in {onboardingData?.goal.title.toLowerCase() || "English conversation"}
                      </p>
                    </div>
                  </div>
          ...
          <TabsContent value="quick-start" className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {quickStartScenarios.map((scenario) => {
                ...
                return (
                  <Card key={scenario.id} className="hover:shadow-lg transition-all cursor-pointer group">
                    <CardContent className="p-6 text-center space-y-4">
                      ...
                      <Button className="w-full" onClick={() => setIsVoiceModalOpen(true)}>
                        Start Now
                      </Button>
                    </CardContent>
                  </Card>
                    ...
                    <div className="p-4 border rounded-lg hover:bg-muted/50 cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Practice contributing to team discussions</p>
                        </div>
                        <Button size="sm" onClick={() => setIsVoiceModalOpen(true)}>
                  ...
                  <div className="p-4 border rounded-lg hover:bg-muted/50 cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Open-ended chat about any topic you choose</p>
                      </div>
                      <Button size="sm" onClick={() => setIsVoiceModalOpen(true)}>
                        <Volume2 className="h-4 w-4 mr-2" />
                        Try Voice
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={conversation.id} className="p-4 border rounded-lg hover:bg-muted/50">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className="text-lg font-bold text-green-600">{conversation.score}%</div>
