...
import { PersonalizedWelcomePanel } from "@/components/personalized-welcome-panel"
...
export function PersonalizedDashboardContent({ onboardingData }: PersonalizedDashboardContentProps) {
  return (
    <div className="space-y-4 md:space-y-6 w-full">
      {/* Personalized Welcome */}
      <PersonalizedWelcomePanel onboardingData={onboardingData} />

      {/* Top row - Daily Practice and Fluency Overview */}
      <div className="grid gap-4 md:gap-6 lg:grid-cols-3 w-full">
        <div className="lg:col-span-2 w-full">
          <DailyPracticePanel onboardingData={onboardingData} />
        </div>
      ...
      <div className="grid gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-3 w-full">
        <div className="w-full">
          <SpeakingAssistantPanel onboardingData={onboardingData} />
        </div>
        <div className="w-full">
          <LearningProgressPanel onboardingData={onboardingData} />
        </div>
